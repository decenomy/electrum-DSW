...
if sys.version_info[:3] < _min_python_version_tuple:
    sys.exit("Error: Electrum-Sapphire requires Python version >= %s..." % MIN_PYTHON_VERSION)
...
if platform.system() in ['Linux', 'FreeBSD', 'DragonFly']:
    ...
    data_files += [
        (os.path.join(usr_share, 'applications/'), ['electrum-sapphire.desktop']),
...
setup(
    ...
    description="Lightweight DECENOMY Standard Wallet",
    author="Thomas Voegtlin",
    author_email="thomasv@electrum.org",
    license="MIT Licence",
    url="https://electrum.org",
    long_description="""Lightweight DECENOMY Standard Wallet""",
)
